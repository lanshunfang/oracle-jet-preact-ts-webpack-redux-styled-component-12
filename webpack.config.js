...
module.exports = {
  ...
  entry: './src/index.ts', // this is the entry point for the Webpack build
  mode: 'development',
  output: {
    filename: 'bundle.js',
  ...
  resolve: {
    ...
    alias: {
      ...
      'jqueryui-amd': path.resolve(__dirname, 'node_modules/@oracle/oraclejet/dist/js/libs/jquery/jqueryui-amd-1.13.0'),
      ...
      // 'ojs': '/Users/plan/dev/demo/oic-adapter-poc-webpack/node_modules/@oracle/oraclejet/dist/js/libs/oj/debug',
      // 
    ...
    new WebpackRequireFixupPlugin(
      {
        ojModuleResources: {
          ...
          // root: path.join(__dirname, "./node_modules/@oracle/oraclejet/dist/js/libs/oj/debug/"),
          root: path.join(__dirname, "./node_modules/@oracle/oraclejet/dist/js/"),
          // 
        ...
        baseResourceUrl: "./node_modules/@oracle/oraclejet/dist/js/oj/debug"
      }
    )
